        ...
        'Soggetto': {
            classico: {
                ...
                caratteristiche: {
                    lunghezza: "media",
                    complessità: "alta",
                    termini_astratti: ["soggetto", "cogito", "pensiero", "esistenza", "certezza"],
                    struttura: "riflessiva"
                }
            },
            contemporaneo: {
                ...
                caratteristiche: {
                    lunghezza: "media",
                    complessità: "alta",
                    termini_astratti: ["soggetto", "potere", "discorso", "costruzione", "disciplina"],
                    struttura: "analitica"
                }
            }
        },
        'Potere': {
            classico: {
                ...
                caratteristiche: {
                    lunghezza: "breve",
                    complessità: "media",
                    termini_astratti: ["potere", "sovranità", "stato", "desiderio", "controllo"],
                    struttura: "politica"
                }
            },
            contemporaneo: {
                ...
                caratteristiche: {
                    lunghezza: "media",
                    complessità: "alta",
                    termini_astratti: ["potere", "diffusione", "strategia", "società", "produzione"],
        ...
        'Libertà': {
            classico: {
                ...
                caratteristiche: {
                    lunghezza: "media",
                    complessità: "alta",
                    termini_astratti: ["libertà", "volontà", "autonomia", "causalità", "ragione"],
                    struttura: "razionale"
                }
            },
            contemporaneo: {
                ...
                caratteristiche: {
                    lunghezza: "breve",
                    complessità: "alta",
                    termini_astratti: ["libertà", "condanna", "esistenza", "responsabilità", "scelta"],
