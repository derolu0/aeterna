...
window.translations = {
    'it': {
        ...
        'map_search_placeholder': '🔍 Cerca filosofo o luogo...',
        'concetto_search_placeholder': '🔍 Cerca concetto (es: Verità, Potere...)',
        ...
        'analytics_user_activity': 'Attività Utenti (Ultimi 7 giorni)',
        ...
        'analytics_frequent_events': 'Eventi Più Frequenti',
    ...
    'en': {
        ...
        'map_search_placeholder': '🔍 Search philosopher or location...',
        'concetto_search_placeholder': '🔍 Search concept (e.g.: Truth, Power...)',
...
window.translatePage = function(lang = null) {
    ...
    if (flagElement && labelElement) {
        flagElement.textContent = language === 'it' ? '🇬🇧' : '🇮🇹';
